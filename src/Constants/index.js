...
export const RAZORPAY_ORDERS_API_URL = 'http://api.razorpay.com/v1/orders';
export const RAZORPAY_TEST_KEY = 'rzp_test_I6E2xi7pm2VOPG';
export const RAZORPAY_TEST_SECRET = '120I15dXhVxr68bXaYTzRMDT';
