...
export default function EditProfile() {
  ...
  const setSignupUserCred = (e) => {
    ...
    if (IsProfileImageChanged) {
      uploadImage(userDetails.profileImage, "user", "small").subscribe(
        (downloadableUrl) => {
          ...
          <div className="input-wrap">
            <FormControl component="fieldset">
              ...
              <RadioGroup
                ...
                aria-label="privacy"
                name="privacy"
                defaultValue={state.loggedInUser.privacy || "Public"}
              ...
              <div className="tnc-content clearfix">
                <div className="checkbox-wrap">
                  <Checkbox
                    ...
                    onChange={(e) =>
                      setUserDetails({ ...userDetails, tnc: e.target.checked })
                    }
