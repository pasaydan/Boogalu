    ...
    return (
        <div className="about-us-page charcoal-bg">
            <div className="container">
                ...
                <p>
                    In 2012, in a widely celebrated achievement, our troupe of talented dancers triumphantly bagged a position in the finals of the 'World Hip hop Dance Championship'. Their inspirational dance journey was made into the movie ABCD 2 and has been marked in the history of dance in India, adding a golden feather in CHOREO CULTURE's hat.With all these golden tales to tell, Choreo Culture focuses and aims to provide its students with the best in class dance education and an unmatched exposure to international platforms, hence excelling at transforming their dance journey.
                </p>
            </div>
        </div>
    );
