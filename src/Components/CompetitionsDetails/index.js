                      ...
                      >
                        ...
                        competitionDetails.isUserEnrolled ? (
                          <div className="sub-titles">
                            ...
                            <span>{VdoUploadDateLimit}</span>
                          </div>
                        ) : (
                          <div className="sub-titles">
                            Upload video till <span>{VdoUploadDateLimit}</span>
                          </div>
                        )}

                        <div className="sub-titles">
                          Winners and Prizes Rule
                        </div>
                        <ul>
                          <li>
                            Top {competitionDetails.prices.length} Winner From
                            Each Category Get Award.
                          </li>
                          <li>
                        ...
                        <ul>
                          ...
                          <li>
                            Result will be declared on 16th June At 4 Pm On
                          </li>
                          <li>Winner will be based on best performance.</li>
                        </ul>
                        <h4 className="before-submit-message">
                          Time To Express Your Talent on Our Platform during
                          this Lockdown
                        </h4>
                      </div>
                    </div>
                    {competitionDetails.type &&
                    competitionDetails.type !== "upcoming" ? (
                      <div className="action-wrap">
                        ...
                        >
                          ...
                          {TnC && (
                            ...
                            >
                              <div>
                                You may not be able to attend the live session
                                if you are late.
                              </div>
                              <div>
                                You may face interruptions during the course of
                                the live stream due to internet connectivity
                                issues.
                              </div>
                              <div>
                                Show details and the artist lineup are subject
                                to change as per the artist’s discretion.
                              </div>
                              <div>
                                {" "}
                                No refunds on purchased tickets are possible,
                                even in case of any rescheduling.
                              </div>
                            </div>
                          )}
                        </div>
                ...
                {ActiveStep === 4 && (
                  <div>
                    <EnrollCompetition
                      ...
                      changeSelectedVdo={() => setActiveStep(3)}
                    />
                  </div>
                )}
                {SelectedVideo?.file && (
