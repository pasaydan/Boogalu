module.exports = {
    ...
    paytm_config: {
        ...
        MID: 'ByHNUn67051447822796', // Get it From https://dashboard.paytm.com/next/apikeys use Test id for test purpose and Production id for Production Purpose
        ...
        PaymentFailureURL: 'http://localhost:3000/subscription' // Failture page URL
    }
}